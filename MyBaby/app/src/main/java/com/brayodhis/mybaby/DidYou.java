...
public class DidYou extends Activity {
TextView did;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_did_you);
		did=(TextView)findViewById(R.id.tvDid);
		Typeface tf=Typeface.createFromAsset(getAssets(),"fonte.ttf");
		did.setTypeface(tf);
		try {
			InputStream is = getAssets().open("know.txt");
			...
			did.setText(text);
			did.setText(Html.fromHtml(text));
			did.setMovementMethod(new ScrollingMovementMethod());
		} catch (IOException e) {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		{
			String lyrics=did.getText().toString();
