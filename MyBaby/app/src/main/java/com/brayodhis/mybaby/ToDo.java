...
TextView fanya;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fanya=(TextView)findViewById(R.id.tvDo);
        Typeface tf=Typeface.createFromAsset(getAssets(),"fonte.ttf");
        fanya.setTypeface(tf);
        try {
            InputStream is = getAssets().open("todo.txt");
            ...
            fanya.setText(text);
            fanya.setText(Html.fromHtml(text));
            fanya.setMovementMethod(new ScrollingMovementMethod());
        } catch (IOException e) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            String lyrics=fanya.getText().toString();
