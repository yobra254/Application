...
TextView vitu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vitu=(TextView)findViewById(R.id.tvThings);
        Typeface tf=Typeface.createFromAsset(getAssets(),"fonte.ttf");
        vitu.setTypeface(tf);
        try {
            InputStream is = getAssets().open("do.txt");
            ...
            vitu.setText(text);
            vitu.setText(Html.fromHtml(text));
            vitu.setMovementMethod(new ScrollingMovementMethod());
        } catch (IOException e) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            String lyrics=vitu.getText().toString();
