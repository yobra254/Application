...
TextView fagia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fagia=(TextView)findViewById(R.id.tvsapa);
        Typeface tf=Typeface.createFromAsset(getAssets(),"fonte.ttf");
        fagia.setTypeface(tf);
        try {
            InputStream is = getAssets().open("thingsToHave.txt");
            ...
            fagia.setText(text);
            fagia.setText(Html.fromHtml(text));
            fagia.setMovementMethod(new ScrollingMovementMethod());
        } catch (IOException e) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            String lyrics=fagia.getText().toString();
